...
namespace OxidEsales\KatModul\Controller\Admin;
/**
 * Class ArticleAttribute
 * Extends \OxidEsales\Eshop\Application\Controller\Admin\ArticleAttribute.
 *
 * @package OxidEsales\KatmModul\Application\Controller\Admin\ArticleAttribute
 */

//class produktkat extends produktkat_parent {
//class ArticleAttribute extends \OxidEsales\Eshop\Application\Controller\Admin\ArticleAttribute 
class ArticleAttribute extends ArticleAttribute_parent
{
    
    
    public function copyselkatlist()
	{
        echo "test testtesttesttesttesttesttest";
    }
